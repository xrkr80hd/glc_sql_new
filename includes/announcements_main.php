...
try {
    ...
    if ($count === 0) {
        echo '<div class="ann-item" style="opacity: 0.7; font-style: italic;">No announcements at this time.</div>';
    }
} catch (Throwable $e) {
    echo '<div class="ann-item" style="opacity: 0.7; font-style: italic;">Announcements are temporarily unavailable.</div>';
}
